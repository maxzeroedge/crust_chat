...
mod models;
use models::chat_ollama::{
    EncodedFile, Message as OllamaMessage, MessageRole as OllamaMessageRole
};

mod tools;
use tools::base_tool::{get_available_tool_definitions, run_respective_tools};
...
async fn loop_chat(history: &Vec<OllamaMessage>, system_prompt: String, start_message: &str) {
